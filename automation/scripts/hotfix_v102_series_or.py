...
Why:
    map_by_key.get(key) can return a pandas Series.
    Python `or` tries to evaluate the Series as True/False and pandas raises:
...
# Handles spacing/newline variants around the same bug.
